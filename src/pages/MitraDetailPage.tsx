...
import { getMitraByMaskingName, searchProducts, type Product } from "@/data/mockData";
...
export default function MitraDetailPage() {
  const { nameStoreMitra } = useParams();
  const navigate = useNavigate();
  const mitra = nameStoreMitra ? getMitraByMaskingName(nameStoreMitra) : null;
      ...
      <section className="headerSearch">
        <div className="container relative">
          <div className="contentSearch">
            ...
            <div className="formSearch subMitra">
              <p className="titleNameMitra">{mitra.name}</p>
          ...
          {dataShow ? (
            <div className="contentResult">
              ...
              <div className="btnClear">
                <button onClick={clearSearch}>Hapus Pencarian</button>
              </div>
            </div>
          ) : (
              ...
              <div className="flex justify-center">
                <div className="w-full md:w-5/12">
                  <p className="content-text">
                    ...
                    <span>Mitra Resmi GadgetShop.</span>
                  </p>
                </div>
              </div>
            </div>
