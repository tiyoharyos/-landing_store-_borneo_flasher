...
const FIELD_BASE = "w-full h-11 border rounded-2xl bg-surface px-4 text-[13.75px] font-body text-ink outline-none transition-all duration-200 [transition-timing-function:var(--ease-apple)] placeholder:text-muted focus:border-brand focus:ring-[3.5px] focus:ring-brand/15";
