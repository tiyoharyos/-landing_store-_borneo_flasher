...
export default function Modal({ open, onClose, title, children, maxWidth = 480 }: ModalProps) {
  ...
  return createPortal(
    ...
    >
      <div
        className="w-full bg-surface border border-line rounded-xl shadow-[var(--shadow-lg)] my-6 sm:my-0 max-h-[90vh] flex flex-col animate-[modalIn_0.18s_cubic-bezier(0.16,1,0.3,1)]"
        style={{ maxWidth }}
